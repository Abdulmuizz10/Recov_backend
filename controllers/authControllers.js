...
// res.cookie("authToken", token, {
//   httpOnly: true,
//   secure: true, // only use true in production with HTTPS
//   sameSite: "None", // "None" requires secure: true, so use "Lax" or "Strict" in dev
//   maxAge: 30 * 24 * 60 * 60 * 1000, // 30 days
//   // domain: not needed in development, let it default
// });
